        ...
        <div class="table-header-container">
          <div class="flex items-center">
            <div class="table-header-toolbar">
              <div>
                <a-button v-auth="'system_button:add'" type="primary" @click="handleAdd">
                  <PlusOutlined />
                  新增
                </a-button>
                <span v-auth="'system_button:batch_enable'">
                  <a-popconfirm
                    title="确定要启用选中的按钮吗？"
                ...
                <span v-auth="'system_button:batch_disable'">
                  <a-popconfirm
                    title="确定要禁用选中的按钮吗？"
                ...
                <span v-auth="'system_button:batch_delete'">
                  <a-popconfirm
                    title="确定要删除选中的按钮吗？"
    ...
    if (col.key === 'icon') {
      ...
      base.customRender = ({ record }: { record: ButtonInfo }) => {
        return h(Switch, {
          ...
          disabled: !userStore.hasPermission('system_button:status'),
